...
async function isAuthenticatedByNumber(userNumberId: string, database = db) {
...
async function setNoteByVidId(note: string, data: any, database = db) {
...
async function getNoteByVidId(vidId: string, database = db) {
