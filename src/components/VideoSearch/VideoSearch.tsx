...
function VideoSearch(props: any) {
    ...
    return (
        <div className="VideoSearch relative h-full w-full flex flex-col items-center overflow-y-auto">
            <form
            ...
            {videos && (
                <div className="VideoSearchContainer h-full overflow-y-auto mt-5 w-full no-scrollbar">
